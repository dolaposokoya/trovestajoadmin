...
import { getAdminAgentCollection, getSuperAdminAgentCollection } from '../../Sagas/Requests';
...
export default function Agent() {
    ...
    const getCollection = async () => {
        try {
            if (token) {
                const response = await getSuperAdminAgentCollection({ agent_id: agentid, token })
